        ...
        <div class="row">
            ...
            <div class="col-6 offset-3 border text-center p-3">
                ...
                <form action="{{ route('users.store') }}" method="post">
                    @csrf
                    <label for="">Введите свой email</label><br>
                    <input class="input-form" type="email" required name="email" placeholder="email"><br>
                    <label for="">Придумайте имя пользователя</label><br>
                    <input class="input-form" type="text" required name="name" placeholder="username"><br>
                    <label for="">Придумайте пароль</label><br>
                    <input class="input-form" type="password" required name="password" placeholder="password"><br>
                    <label for="">Повторите пароль</label><br>
                    <input class="input-form" type="password" required name="password_confirmation" placeholder="confirm password"><br>
